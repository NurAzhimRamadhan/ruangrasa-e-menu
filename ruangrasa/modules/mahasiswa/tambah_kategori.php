    ...
    if (!verify_csrf_token()) {
        ...
        if (empty($nama_kategori)) {
            ...
            if ($stmt->execute()) {
                ...
                error_log("Insert kategori failed: " . $stmt->error);
...
<head>
    ...
    <title>Tambah Kategori - Ruang Rasa</title>
...
<body>
    ...
    <div class="main-container">
        <div class="breadcrumb">
            <a href="admin.php">Admin Panel</a> / <span>Tambah Kategori</span>
        </div>
        ...
        <div class="form-container">
            ...
            <form method="POST" action="" class="admin-form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nama_kategori" name="nama_kategori" required placeholder="Contoh: Makanan Pembuka">
                </div>
